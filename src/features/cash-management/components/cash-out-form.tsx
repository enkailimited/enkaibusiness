...
export function CashOutForm({ businessId, registerId }: CashOutFormProps) {
  ...
  return (
    <Card>
      <CardHeader>
        ...
        <CardDescription>Record money leaving this register</CardDescription>
      </CardHeader>
      <CardContent>
        <form action={formAction} className="space-y-4">
          ...
          <div className="space-y-2">
            ...
            <Input id="reference" name="reference" placeholder="e.g. EXP-001" />
          </div>
