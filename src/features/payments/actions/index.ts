...
export async function createPaymentMethodAction(
  ...
  if (result.success) {
    revalidatePath(`/businesses/${parsed.data.businessId}/payments`);
  }
...
export async function updatePaymentMethodAction(
  ...
  if (result.success) {
    revalidatePath(`/businesses/${method.businessId}/payments`);
  }
...
export async function deletePaymentMethodAction(
  ...
  if (result.success) {
    revalidatePath(`/businesses/${businessId}/payments`);
  }
