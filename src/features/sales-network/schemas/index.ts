...
export const updateSalesHierarchySchema = createSalesHierarchySchema.partial();
...
export type UpdateSalesHierarchySchema = z.infer<typeof updateSalesHierarchySchema>;
