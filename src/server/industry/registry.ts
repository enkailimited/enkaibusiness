...
export const INDUSTRY_REGISTRY: Record<string, FullIndustryDefinition> = {
  ...
  mining: {
    ...
    permissions: [
      { slug: "mining.sites.view", name: "View Sites", module: "sites", description: "View mining sites" },
      { slug: "mining.sites.create", name: "Create Sites", module: "sites", description: "Create new mining sites" },
      { slug: "mining.sites.update", name: "Update Sites", module: "sites", description: "Update mining sites" },
      { slug: "mining.sites.delete", name: "Delete Sites", module: "sites", description: "Delete mining sites" },
      { slug: "mining.licenses.view", name: "View Licenses", module: "claims", description: "View mining licenses" },
      { slug: "mining.licenses.create", name: "Create Licenses", module: "claims", description: "Create mining licenses" },
      { slug: "mining.licenses.update", name: "Update Licenses", module: "claims", description: "Update mining licenses" },
      { slug: "mining.licenses.delete", name: "Delete Licenses", module: "claims", description: "Delete mining licenses" },
      { slug: "mining.equipment.view", name: "View Equipment", module: "equipment", description: "View mining equipment" },
      { slug: "mining.equipment.create", name: "Create Equipment", module: "equipment", description: "Add mining equipment" },
      { slug: "mining.equipment.update", name: "Update Equipment", module: "equipment", description: "Update mining equipment" },
      { slug: "mining.equipment.delete", name: "Delete Equipment", module: "equipment", description: "Remove mining equipment" },
      { slug: "mining.equipment.maintain", name: "Maintain Equipment", module: "equipment", description: "Log equipment service" },
      { slug: "mining.fuel.view", name: "View Fuel", module: "excavation", description: "View fuel transactions" },
      { slug: "mining.fuel.create", name: "Record Fuel", module: "excavation", description: "Record fuel transactions" },
      { slug: "mining.fuel.delete", name: "Delete Fuel", module: "excavation", description: "Delete fuel transactions" },
      { slug: "mining.production.create", name: "Log Production", module: "excavation", description: "Record production output" },
      { slug: "mining.reports.view", name: "View Reports", module: "core", description: "View mining reports" },
    ],
    aiKnowledge: {
      slug: "mining",
